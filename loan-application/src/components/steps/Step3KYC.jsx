  ...
  return (
    <div>
      ...
      >
        ...
        <label
          htmlFor="consent"
          className="text-xs text-[#b3b3b3] leading-relaxed cursor-pointer"
        >
